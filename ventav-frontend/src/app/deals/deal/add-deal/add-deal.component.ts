...
export class AddDealComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    this.form = this.formBuilder.group({
      ...
      buttonColorCode: ['#000000'],
      bannerColorCode: ['#000000'],
      ...
      const sub = this.dealService.getSingleDeal(this.dealId).subscribe({
        next: (res) => {
          ...
          this.form.patchValue({
            ...
            buttonColorCode: res['data'].buttonColorCode ? res['data'].buttonColorCode : '#000000',
            bannerColorCode: res['data'].bannerColorCode ? res['data'].bannerColorCode : '#000000',
            textColorCode: res['data'].textColorCode ? res['data'].textColorCode : '#ffffff',
